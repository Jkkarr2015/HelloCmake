//
// Created by jkkarr on 12/11/2017.
//
...
public:
    ...
    vector<sBlockExtent> getVrectPBFBlockExtents() {return vrectPBFBlockExtents;}
	void setVrectPBFBlockExtents(vector<sBlockExtent> newVrect) {vrectPBFBlockExtents = newVrect;}
